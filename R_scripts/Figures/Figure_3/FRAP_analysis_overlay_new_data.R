...
TablePaths <- c(
  ...
  "/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl232/20230928_Intensity.csv",
  "/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl232/20231005_Intensity.csv",
  ...
  "/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl236/20230928_Intensity.csv",
  "/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl236/20231005_Intensity.csv",
  ...
  "/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl240/20230928_Intensity.csv",
  "/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl240/20231005_Intensity.csv",
  ...
  "/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl321/20231010_Intensity.csv"
)
...
# two wells imaged on 20231010 which are counted as two replicates
Replicate_20231010 <- 
  fread("/Volumes/TAYLOR-LAB/Synthetic Myddosome Paper/FRAP_data_analysis/cl321/20231011_Intensity.csv"
        ) %>% 
  mutate(
    DATE = paste(substring(IMAGE, 1, 8), sep = "", "_2")
  )

Tracks <- rbind(Table, Replicate_20231010)
