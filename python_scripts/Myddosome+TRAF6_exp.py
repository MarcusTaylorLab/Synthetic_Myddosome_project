...
file_path = '//data-tay/TAYLOR-LAB/Synthetic Myddosome Paper/python_scripts/Modeling_Mauriz/Figures/df_size2_3frames.csv.gz'
...
# filename = '//data-tay/TAYLOR-LAB/Synthetic Myddosome Paper/python_scripts/Modeling_Mauriz/Figures/MyD88_TRAF6_growth_exp.png'  # replace with your desired file path
